...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ...
                    ""type"": ""Button"",
                    ""id"": ""1a0c22ed-c43e-4d02-99ac-7f41702c7afb"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                ...
                {
                    ""name"": ""PutInteractions"",
                    ""type"": ""Button"",
                    ""id"": ""2292d2cc-c190-47c3-9a8d-9dea9b77f449"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""c0d20138-3c05-4938-8a2f-964adbbd8048"",
                    ""path"": ""<Keyboard>/e"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard&Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""72c205de-49b7-47ce-b40b-2425572353f7"",
                    ""path"": ""<Keyboard>/q"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard&Mouse"",
                    ""action"": ""PutInteractions"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
    ...
    ""controlSchemes"": [
        ...
        m_Player_Getinteractions = m_Player.FindAction("Getinteractions", throwIfNotFound: true);
        m_Player_PutInteractions = m_Player.FindAction("PutInteractions", throwIfNotFound: true);
        // UI
    ...
    private readonly InputAction m_Player_Getinteractions;
    private readonly InputAction m_Player_PutInteractions;
    /// <summary>
    ...
    public struct PlayerActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "Player/Getinteractions".
        /// </summary>
        public InputAction @Getinteractions => m_Wrapper.m_Player_Getinteractions;
        /// <summary>
        /// Provides access to the underlying input action "Player/PutInteractions".
        /// </summary>
        public InputAction @PutInteractions => m_Wrapper.m_Player_PutInteractions;
        /// <summary>
        ...
        public void AddCallbacks(IPlayerActions instance)
        {
            ...
            @Getinteractions.started += instance.OnGetinteractions;
            @Getinteractions.performed += instance.OnGetinteractions;
            @Getinteractions.canceled += instance.OnGetinteractions;
            @PutInteractions.started += instance.OnPutInteractions;
            @PutInteractions.performed += instance.OnPutInteractions;
            @PutInteractions.canceled += instance.OnPutInteractions;
        }
    ...
    public interface IPlayerActions
    {
        ...
        /// <summary>
        /// Method invoked when associated input action "Getinteractions" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        void OnGetinteractions(InputAction.CallbackContext context);
        /// <summary>
        /// Method invoked when associated input action "PutInteractions" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        void OnPutInteractions(InputAction.CallbackContext context);
    }
    /// <summary>
